...
def rpmnet_arguments():
    ...
    parser.add_argument('--num_reg_iter', type=int, default=3,
...
def rpmnet_train_arguments():
    ...
    # Training parameters
    parser.add_argument('--lr', default=1e-6, type=float, help='Learning rate during training')
...
def rpmnet_eval_arguments():
    ...
    # settings for input data_loader
    parser.add_argument('--test_category_file', type=str, metavar='PATH', default='./data_loader/modelnet40_half1.txt',
